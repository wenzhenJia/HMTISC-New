...
import numpy as np
import STResNet.deepst.metrics as metrics
from keras.callbacks import EarlyStopping, ModelCheckpoint
from keras.optimizers import Adam
from STResNet.deepst.config import Config
from STResNet.deepst.datasets import BikeNYC
from STResNet.deepst.models.STResNet import stresnet

np.random.seed(1337)  # for reproducibility

def STResNetFunc(map_height=16, map_width = 8 ):
    # grid size
    ...
    path_result = './STResNet/RET'
    path_model = './STResNet/MODEL'
